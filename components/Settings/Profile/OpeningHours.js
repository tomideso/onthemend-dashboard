            ...
            <table className={`
                ...
                <thead>
                    <tr className="uk-background-muted">
                        ...
                        <th className="uk-text-capitalize uk-text-emphasis uk-text-center">Open</th>
                        ...
                        <th className="uk-text-capitalize uk-text-emphasis uk-text-center">24 Hours</th>
                    </tr>
                </thead>
                <tbody>
                    {
                        defaultProps.map((val, i) => (
                            <tr key={i}>
                                ...
                                <td>{val.endtime}</td>
                                <td>
                                    <label><input className="uk-checkbox" type="checkbox" defaultChecked={val.allday} /></label>
                                </td>
                            </tr>
                        ))
                    }
